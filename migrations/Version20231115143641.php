 ...
 */
final class Version20231115143641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, name VARCHAR(255) NOT NULL, price NUMERIC(8, 2) NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
